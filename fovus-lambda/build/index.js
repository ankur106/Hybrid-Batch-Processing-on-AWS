...
var lambdaHandler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var id, obj, command, res, response, err_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                obj = {
                    'id': id,
                    'input_text': ((_a = event.queryStringParameters) === null || _a === void 0 ? void 0 : _a.inputText) || '',
                    'input_file_path': "fovus-input/" + ((_b = event.queryStringParameters) === null || _b === void 0 ? void 0 : _b.inputFileName) || ''
                };
